...
class Parag_Mail_Inspector_Tools {
	...
	public static function render_page() {
		...
		<div class="parag-mail-inspector-tools-grid">
			...
			<div class="parag-mail-inspector-card parag-mail-inspector-danger-card">
				...
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" data-parag-mail-inspector-confirm="<?php esc_attr_e( 'Clear all MailTally logs?', 'parag-mail-inspector' ); ?>">
	...
	public static function send_test_email() {
		...
		$subject   = __( 'MailTally test email', 'parag-mail-inspector' );
